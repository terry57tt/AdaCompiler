...
//                    }
               ...
               if (currentNode.getToken().getType().equals(TokenType.IDENTIFIER) && !currentNode.getParent().getValue().equalsIgnoreCase("procedure") && !currentNode.getParent().getValue().equalsIgnoreCase("call")
